...
namespace WindowsFormsApp1.DLL
{
    class DeaCustDAL
    {
        ...
        public bool Insert(DeaCustBLL data)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO tbl_dea_cust (type, name, email, contact, address, added_date, added_by) VALUES (@type, @name, @email, @contact, @address, @added_date, @added_by)";
        ...
        public bool Delete(DeaCustBLL data)
        {
            ...
            try
            {
                ...
                string query = "DELETE FROM tbl_dea_cust WHERE id=@id";
        ...
        public DataTable Search(string keyword)
        {
            ...
            try
            {
                ...
                string query = "SELECT * FROM tbl_dea_cust WHERE id LIKE '%" + keyword + "%' OR type LIKE '%" + keyword + "%' OR name LIKE '%" + keyword + "%'";
        ...
        public DeaCustBLL SearchDealerCustomerForTransaction(string keyword)
        {
            ...
            try
            {
                ...
                string query = "SELECT name, email, contact, address from tbl_dea_cust WHERE id LIKE '%" + keyword + "%' OR name LIKE '%" + keyword + "%'";
        ...
        public DeaCustBLL GetDeaCustIDFromName(string Name)
        {
            ...
            try
            {
                ...
                string query = "SELECT id FROM tbl_dea_cust WHERE name='" + Name + "'";
